...
# DiffuChannel
NEW - The Conditioned Diffusion approach
## To Do
1. Save the model_name with some reference to the first file in /pages
2. Default name for download is the original file bsename with _DDM inserted.
